...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_2_DESC "Zero X & Y axes"
  #define MAIN_MENU_ITEM_2_GCODE "G92 X0 Y0"

  #define MAIN_MENU_ITEM_3_DESC "Zero Z axis"
  #define MAIN_MENU_ITEM_3_GCODE "G92 Z0"

  #define MAIN_MENU_ITEM_4_DESC "Go to zero"
  #define MAIN_MENU_ITEM_4_GCODE "G1 X0 Y0 Z0 F3000"

  #define MAIN_MENU_ITEM_5_DESC "Disable steppers"
  #define MAIN_MENU_ITEM_5_GCODE "M84"
#endif
...
//#define CUSTOM_MENU_CONFIG
  ...
  #define CUSTOM_MENU_CONFIG_TITLE "CNC Commands"
  //#define CUSTOM_MENU_CONFIG_SCRIPT_DONE "M117 Done"
  //#define CUSTOM_MENU_CONFIG_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_CONFIG_SCRIPT_RETURN  // Return to status screen after a script
  //#define CUSTOM_MENU_CONFIG_ONLY_IDLE        // Only show custom menu when the machine is idle

  #define CONFIG_MENU_ITEM_1_DESC "Zero all axes"
  #define CONFIG_MENU_ITEM_1_GCODE "G92 X0 Y0 Z0"

  #define CONFIG_MENU_ITEM_2_DESC "Zero X & Y axes"
  #define CONFIG_MENU_ITEM_2_GCODE "G92 X0 Y0"

  #define CONFIG_MENU_ITEM_3_DESC "Zero Z axis"
  #define CONFIG_MENU_ITEM_3_GCODE "G92 Z0"

  #define CONFIG_MENU_ITEM_4_DESC "Go to zero"
  #define CONFIG_MENU_ITEM_4_GCODE "G1 X0 Y0 Z0 F500"
